...
import forex.http.rateLimiter.error.{ InvalidToken, TokenExhausted }
...
class RatesHttpRoutes[F[_]: Sync](rates: RatesProgram[F], rateLimiter: F[RateLimiterAlgebra[F]]) extends Http4sDsl[F] {
